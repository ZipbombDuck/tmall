package com.hucu.tmall.service;
...
import com.hucu.tmall.mapper.CategoryDAO;
import com.hucu.tmall.domain.Category;
import com.hucu.tmall.domain.Product;
import com.hucu.tmall.util.Page4Navigator;

/**
 * 使用 CategoryService 作为实现类:！！！！借鉴博客内容
 * redis缓存：
 *   给分类加上如下注解，就表示分类在缓存里的keys：下载的redis-client可以查看categories~keys
 *   用于维护分类信息在 redis里都有哪些 key.
 * 注意session同步！！！！重点
 * redis缓存失效
 * (其他service都一样)
 *
